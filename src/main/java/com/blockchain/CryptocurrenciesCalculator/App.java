...
public class App {
    ...
    {		
		...
		//This is our A value
		//It represents total assets miner has earned due to mining blocks from startDate to endDate.
		double sumFees=0;
		...
		//Starting Finding Mined Blocks and Retrieving their details by Looping through transactions.
		...
		for(int i=0;i<listTransactions.size();i++) {
			...
			if(date.after(startDate) && date.before(endDate)) {
				...
				//Total Fee received for mining a block = List of output fees of that transactions
